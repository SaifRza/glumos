...
<?php foreach($employers as $company){?>
      ...
      <div class="row d-flex justify-content-around">
          ...
          <div class="col-2 v-med">
              <?=$company->verification_file!=""?'<a class="btn btn-primary bg-theme py-1 px-2" href="'.base_url('httpdocs/document-files/')."/".$company->verification_file.'"  target="_blank">View</a>':'<a class="btn btn-primary bg-theme mt-2 py-1 px-2" href="'.base_url('httpdocs/document-files/')."/".$company->verification_file.'"  target="_blank">Not Av.</a>'?>
          </div>
