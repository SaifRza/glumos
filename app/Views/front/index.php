...
<!-- Modal -->
   <div class="width:100%">
    ...
    <?= $this->include('front/components/hero-section');?>
     <?php if($browsefor=="hirings"){?>
     <?= $this->include('front/components/browse-freelancers');?> 
     <?php }elseif($browsefor=="jobs"||$browsefor==""){?>
     <?= $this->include('front/components/browse-jobs');?> 
