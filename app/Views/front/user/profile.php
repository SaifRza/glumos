...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script>
  ...
  <style>
    .img-bg{
        background-image: url("<?php echo base_url('/httpdocs/featured-images/');?>/<?=$assets[0]->featured_img;?>");
...
<!-- Modal -->
  ...
  //print_r($assets);
  ?>
  <div class="mt-3 p-2 dashboard-hero" style="min-height:100vh">
   <!----Here---->
   <div class="col-12 img-bg" style="padding-top:200px;max-width:900px;margin:auto">
         <span class="material-icons-outlined right-icon bg-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">edit</span>
       <div class="styled-logo">
           <img src="<?php echo base_url('/httpdocs/logo-images/');?>/<?=$assets[0]->logo_img;?>" class="logo-img">
       </div>
    </div>   
   <!---Ends Here---->
  ...
  <div class="bg-white mt-2 p-1 rounded" style="max-width:900px;margin:auto">
             ...
             <div class=" w-50 row d-flex p-5">
                  <div class="col-auto">
                    ...
                    <p class="text-muted m-0 text-left h5"> <?=$assets[0]->location_name==''?'Location ':$assets[0]->location_name;?> </p>
                 </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="<?php echo base_url('upload-featured-photo/1');?>" enctype="multipart/form-data">
          ...
          <form method="POST" action="<?php echo base_url('upload-featured-photo/2');?>" enctype="multipart/form-data">
             ...
             <div class="text-center">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="loc_name" value="<?=$assets[0]->location_name;?>" placeholder="Enter your company Location " class="form-control" id="loc">
                </div>
                <script>
                  var loadFile = function(event) {
