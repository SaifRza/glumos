...
<div class="col-4 m-auto mt-0" style="height:auto">
   ...
   <div class="bg-white p-3 mt-3  " style="border-radius:20px">
       <h6 class="d-flex justify-content-between">General Details</h6>
       <hr class="m-0">
...
<div class="bg-white p-3 mt-3  " style="border-radius:20px">
       ...
       <form method="POST" class="mt-3" id="work-type" action="<?php echo base_url('/update-user-info/10');?>" >
        <div class="form-check form-switch my-2">
            <label class="form-check-label " for="freelanceSwitch">
                ...
                Freelance <?php }else{?> Fulltime <?php }?></label>
 ...
 <div class="bg-white p-3 mt-3  " style="border-radius:20px">
       <h6 class="d-flex justify-content-between">Skills</h6>
       <hr class="m-0">
       <p class="text-dark fw-bolder">skills</p>
       <?php 
...
<div class="bg-white p-3 mt-3  " style="border-radius:20px">
       <h6 class="d-flex justify-content-between">Salary Expec..   </h6>
       <hr class="m-0">
...
<div class="bg-white p-3 mt-3  " style="border-radius:20px">
       ...
       <hr class="m-0">
     <?php if($myData[0]->loc_pref=="1"){?>
     
     <p class="m-0 fw-bolder">On Site</p>
     <?php }else{?>
     <p class="m-0 fw-bolder">Remote</p> 
     <?php }?>
...
<div class="col-8 mx-auto text-center mt-0">
  <div class="bg-white p-3 mt-3  " style="border-radius:20px">
       <h6 class="d-flex justify-content-between">Profile Picture</h6>
       <hr class="m-0">
  ...
  <div class="bg-white p-3 mt-3  " style="border-radius:20px">
       <h6 class="d-flex justify-content-between">Experience</h6>
       <hr class="m-0">
     ...
     <?php foreach($exp as $experience){?>
         ...
         <div class="row d-flex justify-content-around">
           <div class="col-10 row d-flex justify-content-start">
               ...
               <img src="<?php echo base_url();?>/httpdocs/logo-images/default_logo.png" class="img-fluid m-auto" style="height:100px;width:100px;border-radius:50%">    
               </div>
               <div class="col-auto my-auto">
                    <h5 class="m-0"><?=$experience->title;?></h5>
                   <p class="m-0"><?=$experience->institution_name;?></p>
               </div>
           </div>
           <div class="col-auto my-auto">
           <?=$experience->years;?>:y  
  ...
  <div class="bg-white p-3 mt-3  " style="border-radius:20px">
       <h6 class="d-flex justify-content-between">Education</h6>
       <hr class="m-0">
     <div class="bg-light" style=""> 
      <?php foreach($exp as $experience){?>
        ...
        <div class="row d-flex justify-content-between">
           <div class="col-11 row d-flex justify-content-start">
               <div class="col-auto my-auto">
               <img src="https://esquilo.io/png/thumb/Jx4YLmGzgmhqCWo-Graduation-Cap-PNG-Transparent-Image.png" class="img-fluid m-auto" style="height:100px;width:100px;border-radius:50%">    
               </div>
               <div class="col-auto my-auto">
                    <h5 class="m-0"><?=$experience->title;?></h5>
                   <p class="m-0"><?=$experience->institution_name;?></p>
  ...
  <div class="modal-dialog">
   ...
   <form method="POST" action="<?php echo base_url('/update-user-info/9');?>"     >
       <div class="form-group text-center mb-3">
             <label for="inputJName" class="form-label">Course Name</label>
           <input type="text" class="form-control" name="job_title" id="inputJName" value="" placeholder="Course Name ">
       </div>       
  ...
  <div class="modal-dialog">
   ...
   <form method="POST" action="<?php echo base_url('/update-user-info/9');?>"     >
       <div class="form-group text-center mb-3">
           ...
           <input type="text" class="form-control" name="job_title" id="inputJName" value="" placeholder="Job Position">
       </div>       
       <div class="form-group row d-flex justify-content-between text-center mb-3">
           <div class="col-9">
             <label for="inputCName" class="form-label">Company Or Firm Name</label>
