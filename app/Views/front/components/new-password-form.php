...
<div class="row d-flex justify-content-around w-100">
    ...
    <div class="col-md-7 pt-5" style="height:100vh">
       ...
       <!--form-->
       <?php if($error){
           echo '<h3 class="text-center">'.$error_message.'</h3>';
       }else{?>
       <div class="w-100 p-5 bg-light mx-3 my-5">
  <div class="m-auto">      
  <label for="username" class="form-label m-0 labler">New Password</label>  
       <div class="input-group mb-2 mt-2">         
  <input type="password" class="form-control" placeholder="Enter New Password" aria-label="Username" id="passworded1" name="passworded1" aria-describedby="basic-addon1">
</div>
  <label for="passworded2" class="form-label m-0 labler">Confirm Your Password</label> 
      <div class="input-group mb-2 mt-2">         
  <input type="password" class="form-control" placeholder="Confirm Your Password" aria-label="Username" id="passworded2" name="passworded2" aria-describedby="basic-addon1">
</div>
...
<div class="text-center mt-2">
    <button class="btn btn-primary w-75 m-auto"  id="change-password">Change It</button>
</div>
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
   <script>
           ...
           $("#change-password").click(function(){
            ...
            var pass1 = document.getElementById('passworded1').value;
             var pass2= document.getElementById('passworded2').value;
            if(pass1==pass2){
             
             $.ajax({  
                        method: "POST",
                        url: "<?php echo base_url('reset-my-password') ?>",
                        data:{
                       'passworded':pass1,
